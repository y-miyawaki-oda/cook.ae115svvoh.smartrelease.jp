<?php
	...
	function add_files() {
		...
		elseif(is_page("vlog")) {
			...
			elseif(is_page(array("management", "pan", "culinary", "training", "fashiondesign_s", "fasiontechnical_s", "merchandising", "guidance", "tuition", "foreignstudentguideline", "tuitionsupport"))) {
			...
			wp_enqueue_style('c-cook', get_template_directory_uri().'/css/cook.css', array('c-parts'), '1.0', 'all');
		...
		wp_enqueue_style('c-font03', 'https://fonts.googleapis.com/css2?family=M+PLUS+1p:wght@400&display=swap', array('c-font02'), '1.0', 'all');
		wp_enqueue_style('c-font04', 'https://fonts.googleapis.com/css2?family=Nunito:wght@300&display=swap', array('c-font03'), '1.0', 'all');
