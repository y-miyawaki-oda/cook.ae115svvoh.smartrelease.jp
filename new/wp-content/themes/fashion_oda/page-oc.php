	...
	<div class="bg_dot">
		...
		<section id="about" class="sec_about is_anime fadein">
			<div class="wrap w1200">
				<div class="head">
					<div class="img">
						<div class="img_cross cross01"><img src="/new/wp-content/uploads/2021/04/2021_oc_c_ボロネーゼss.jpg" alt=""></div>
						<div class="img_cross cross02"><img src="/new/wp-content/uploads/2021/04/2021_oc_c_寿司と茶碗蒸しss.jpg" alt=""></div>
					</div>
					<h2 class="ttl">
						<span class="mark">様々なジャンルのメニューに挑戦！</span><br>
						織田調理の<br><span class="color">オープンキャンパス！</span>
					</h2>
				</div>
				<div class="detail">
					<h3 class="box_ttl">織田調理の<br class="sp br_tab"><span class="big">オープンキャンパスでは...</span></h3>
					<ul class="list">
						<li>
						...
						<li>
							...
							<h4 class="txt"><span class="big">入学・就職</span>について<br class="pc">知れる</h4>
						</li>
						<li>
				...
				<div class="menu">
					<h3 class="box_ttl">1年間を通して<br><span class="big">様々な料理・お菓子に</span><br class="sp br_tab">挑戦できます！</h3>
					<div class="grid">
						<ul class="grid2">
							<li class="orange">
								<img class="icon" src="<?php echo esc_url(get_template_directory_uri()); ?>/img/opencampus/western_1.png" />
								<p class="txt">西洋料理実習</p>
							</li>
							<li class="red">
								<img class="icon" src="<?php echo esc_url(get_template_directory_uri()); ?>/img/opencampus/chinese_1.png" />
								<p class="txt">中国料理実習</p>
							</li>
							<li class="cyan">
								<img class="icon" src="<?php echo esc_url(get_template_directory_uri()); ?>/img/opencampus/japanese_1.png" />
								<p class="txt">日本料理実習</p>
							</li>
							<li class="pink">
								<img class="icon" src="<?php echo esc_url(get_template_directory_uri()); ?>/img/opencampus/confectionery_1.png" />
								<p class="txt">製菓実習</p>
							</li>
							<li class="brown">
								<img class="icon" src="<?php echo esc_url(get_template_directory_uri()); ?>/img/opencampus/bread_1.png" />
								<p class="txt">製パン実習</p>
							</li>
							<li class="green-light">
								<img class="icon" src="<?php echo esc_url(get_template_directory_uri()); ?>/img/opencampus/school_1.png" />
								<p class="txt">給食実習</p>
							</li>
							<li class="green-strong">
								<img class="icon" src="<?php echo esc_url(get_template_directory_uri()); ?>/img/opencampus/special_1.png" />
			...
			<?php
				...
				foreach($calendar as $key => $val) {
					...
					if($val["class"] !== "prev" && $val["class"] !== "next") {
						...
						if($oc_arr[$date_txt]["bread"] || $oc_arr[$date_txt]["group"] || $oc_arr[$date_txt]["chinese"] || $oc_arr[$date_txt]["japanese"] || $oc_arr[$date_txt]["western"] || $oc_arr[$date_txt]["confectionery"] || $oc_arr[$date_txt]["special"]) {
							$table .= '<ul class="icon">';
							if($oc_arr[$date_txt]["bread"]) {
								$table .= '<li><a href="#oc'.$oc_arr[$date_txt]["bread"].'"><img src="'.esc_url(get_template_directory_uri()).'/img/opencampus/bread_1.png" alt=""></a></li>';
							}
							if($oc_arr[$date_txt]["group"]) {
								$table .= '<li><a href="#oc'.$oc_arr[$date_txt]["group"].'"><img src="'.esc_url(get_template_directory_uri()).'/img/opencampus/school_1.png" alt=""></a></li>';
							}
							if($oc_arr[$date_txt]["confectionery"]) {
								$table .= '<li><a href="#oc'.$oc_arr[$date_txt]["confectionery"].'"><img src="'.esc_url(get_template_directory_uri()).'/img/opencampus/confectionery_1.png" alt=""></a></li>';
							}
							if($oc_arr[$date_txt]["chinese"]) {
								$table .= '<li><a href="#oc'.$oc_arr[$date_txt]["chinese"].'"><img src="'.esc_url(get_template_directory_uri()).'/img/opencampus/chinese_1.png" alt=""></a></li>';
							}
							if($oc_arr[$date_txt]["japanese"]) {
								$table .= '<li><a href="#oc'.$oc_arr[$date_txt]["japanese"].'"><img src="'.esc_url(get_template_directory_uri()).'/img/opencampus/japanese_1.png" alt=""></a></li>';
							}
							if($oc_arr[$date_txt]["western"]) {
								$table .= '<li><a href="#oc'.$oc_arr[$date_txt]["western"].'"><img src="'.esc_url(get_template_directory_uri()).'/img/opencampus/western_1.png" alt=""></a></li>';
							}
							if($oc_arr[$date_txt]["special"]) {
								$table .= '<li><a href="#oc'.$oc_arr[$date_txt]["special"].'"><img src="'.esc_url(get_template_directory_uri()).'/img/opencampus/special_1.png" alt=""></a></li>';
							}
							$table .= '</ul>';
						}
					}
		...
		?>
					...
					<div class="course_center">
						<div class="course grid2 cal">
							<div class="item">
								<p class="icon"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/opencampus/western_1.png" alt=""></p>
								<p class="txt">西洋料理実習</p>
							</div>
							<div class="item">
								<p class="icon"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/opencampus/chinese_1.png" alt=""></p>
								<p class="txt">中国料理実習</p>
							</div>
							<div class="item">
								<p class="icon"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/opencampus/japanese_1.png" alt=""></p>
								<p class="txt">日本料理実習</p>
							</div>
							<div class="item">
								<p class="icon"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/opencampus/confectionery_1.png" alt=""></p>
								<p class="txt">製菓実習</p>
							</div>
							<div class="item">
								<p class="icon"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/opencampus/bread_1.png" alt=""></p>
								<p class="txt">製パン実習</p>
							</div>
							<div class="item">
								<p class="icon"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/opencampus/school_1.png" alt=""></p>
								<p class="txt">給食実習</p>
							</div>
							<div class="item">
								<p class="icon"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/opencampus/special_1.png" alt=""></p>
								<p class="txt">スペシャル体験</p>
							</div>
						</div>
					</div>
		...
		<?php if($posts): ?>
			...
			<?php foreach($posts as $key => $post): setup_postdata($post); ?>
				<?php
					...
					elseif($cat === "confectionery") {
						$cat_class = 'pink';
						$cat_icon = 'confectionery';
						$cat_txt = '製菓実習';
					}
					elseif($cat === "special") {
						$cat_class = 'green-strong';
						$cat_icon = 'special';
						$cat_txt = 'スペシャル体験';
					}
				?>
					<li id="oc<?php the_ID(); ?>" class="box_<?php echo $cat_class; ?>">
						...
						<div class="inner">
							<div class="cnt">
								<div class="img"><?php the_post_thumbnail("opencampus_list2"); ?></div>
								<div class="box_txt">
									<div class="info">
